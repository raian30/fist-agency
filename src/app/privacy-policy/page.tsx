export default function Home() {
    return (
        <div className={'min-h-screen bg-[#121212] flex flex-col gap-20 lg:gap-14 justify-start px-5 py-32 md:px-10 lg:px-24'}>
           <h1 className={'text-4xl'}>Privacy Policy for FIST AGENCY LLC</h1>
            <p>
                At fist.agency, accessible from https://fist.agency, one of our main priorities is the privacy of our
                visitors. This Privacy Policy document contains types of information that is collected and recorded by
                fist.agency and how we use it.<br/>
                ...
                regards to the information that they shared and/or collect in fist.agency. This policy is not applicable
                to any information collected offline or via channels other than this website.<br/><br/>

                <b className={'text-2xl'}>Consent</b><br/><br/>

                By using our website, you hereby consent to our Privacy Policy and agree to its terms.<br/><br/>

                <b className={'text-2xl'}>Information We Collect</b><br/><br/>
                ...
                company name, address, email address, and telephone number.<br/><br/>

                <b className={'text-2xl'}>How We Use Your Information</b><br/><br/>
                ...
                <b className={'text-2xl'}>Log Files</b><br/><br/>

                FIST AGENCY LLC follows a standard procedure of using log files. These files log visitors when they
                ...
                <b className={'text-2xl'}>Advertising Partners Privacy Policies</b><br/><br/>

                You may consult this list to find the Privacy Policy for each of the advertising partners of
                fist.agency.<br/>

                Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                are used in their respective advertisements and links that appear on fist.agency, which are sent
                ...
                Note that fist.agency has no access to or control over these cookies that are used by third-party
                advertisers.<br/><br/>

                <b className={'text-2xl'}>Third Party Privacy Policies</b><br/><br/>

                FIST AGENCY LLC's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                respective websites.<br/><br/>

                <b className={'text-2xl'}>CCPA Privacy Rights (Do Not Sell My Personal Information)</b><br/><br/>
                ...
                <b className={'text-2xl'}>GDPR Data Protection Rights</b><br/><br/>
                ...
                <b className={'text-2xl'}>Children's Information</b><br/><br/>
                ...
                FIST AGENCY LLC does not knowingly collect any Personal Identifiable Information from children under the
