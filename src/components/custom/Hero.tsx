            ...
            <section className={'flex flex-col gap-14 h-screen justify-center px-24'}>
                <div className={'flex gap-12 items-center'}>
                    ...
                    <div className={'overflow-hidden relative animation-wrapper'}>
                        <p className={'text-xl text-transparent select-none leading-[1.6rem] pointer-events-none font-medium'}>Total
                            commitment</p>
                        <p className={'text-xl font-medium absolute top-0 left-0 animation-item-1'}>Total commitment</p>
                        <p className={'text-xl font-medium absolute top-0 left-0 translate-y-full animation-item-2'}>100%
                            dedication</p>
                        <p className={'text-xl font-medium absolute top-0 left-0 translate-y-full animation-item-3'}>No
                            bull$hit</p>
                    </div>
                </div>
                <h1 className={'text-8xl leading-[1.4] font-medium '}>We Don&apos;t Build Pretty Sites,<br/> We Build
                    Winners.
                </h1>
                <Link href={'/#contact'}
